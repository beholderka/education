...
let nums_10_19Array = 'десять одинадцать двенадцать тринадцать четырнадцать пятнадцать шестнадцать семнадцать восемнадцать девятнадцать'.split(' ');
...
module.exports = {fPrint0_999b, flipInt, fAB, fPrint0_999, fDigitToString, fPrintNum0_999, fDayWeek}